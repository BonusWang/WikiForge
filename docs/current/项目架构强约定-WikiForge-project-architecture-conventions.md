...
- `sources`、`system_settings`、`model_providers`、MCP、向量、LifeOS、知识体检、AI Review、旧 Source Note、旧 Wiki Compile、Link Source、Orchestration 相关表不进入 MVP0 主流程。
