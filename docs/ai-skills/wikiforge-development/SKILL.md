...
1. Read `AGENTS.md`.
2. Read the latest `docs/archive/YYYY-MM-DD/*归档索引-archive-index-vX.Y.md`.
3. Read the current task's relevant reference file in this skill.
4. Confirm the current MVP stage before changing code.
5. Keep changes inside the target service or document boundary.
...
Use `references/development-workflow.md` before starting a new development slice.
