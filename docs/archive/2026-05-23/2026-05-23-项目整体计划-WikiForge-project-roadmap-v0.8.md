...
- 当前工程阶段：MVP3 文档解析已实现并通过后端验证；Markdown / TXT / PDF / Word 正文抽取和 Source Note 摘录已完成；下一内部开发节点为 MVP4 AI 辅助整理与审核
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v2.6.md`
3. 本文档
...
| [ ] | S6 MVP4 AI 辅助整理 | Next | 接入国内模型，生成摘要、标签、分类建议和审核队列 | 0.07 | 人工审核后写入 Obsidian |
