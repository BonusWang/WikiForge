...
- 当前工程阶段：R4-5 集成验证完成，准备发布 `0.08-preview.3`；MVP5 HTTP Preview 主线完成，后续进入 V1 在线资料与个人记录阶段
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v4.1.md`
3. 本文档
...
- 版本更新记录已新增 `0.08-preview.3`，本节点后续合入 `main` 并创建标签 / GitHub Release。
