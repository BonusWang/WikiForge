...
| MVP 3 | `source_contents`、`agent_runs`、`agent_steps`、`review_items` | Agent Service / Core Service，MVP 3 前再确认 | AI 辅助整理和审核队列 |
| MVP 4 | `mcp_servers`、`mcp_tool_calls` | MCP Service | 轻量 MCP 预览 |
