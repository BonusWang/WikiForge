# 2026-05-23 WikiForge 文档归档索引 v2.5
...
当前已完成 MVP3 文档解析首轮，下一内部开发节点为 PDF / Word 基础文本抽取：
...
- MVP3 文档解析首轮已完成：`source_contents` 表已落地，Markdown / TXT 正文抽取已打通，Source Note 草案已展示正文摘录。
- 本轮验证通过：后端 Maven 多模块测试、前端构建、Docker Compose config。
- 下一内部开发节点进入 R2-3 / R2-4：PDF 基础文本抽取和 Word `.docx` 基础文本抽取。
