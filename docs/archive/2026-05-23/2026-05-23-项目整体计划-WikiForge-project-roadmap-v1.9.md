...
- 当前工程阶段：R4-4 Obsidian Note 读取与个人记录写入已完成定向验证；下一内部开发节点为 R4-5 MCP 调用展示与 OpenClaw / Hermes 接入说明
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v3.7.md`
3. 本文档
