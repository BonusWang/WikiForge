...
- 当前工程阶段：R4-5 已完成 MCP tools / calls 只读看板、调用日志查询测试、Agent Team 状态集成和 OpenClaw / Hermes 本机接入说明；下一步进入 R4-5 集成验证和发布收口
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v4.0.md`
3. 本文档
