# 2026-05-23 WikiForge 文档归档索引 v0.7
...
| `2026-05-23-AI开发规则-AGENTS-v0.4.md` | v0.4 | 补充 Git 提交规则，明确编译产物和本地数据不提交 |
...
| `AI开发Skill-WikiForge-development-skill-v0.3/` | v0.3 | 补充 Git 提交规则后的 Skill 快照 |
