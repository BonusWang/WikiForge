...
- 当前工程阶段：MVP4 AI 辅助整理与审核首轮已实现；Agent 运行账本、审核队列、可配置 AI Provider 适配和 Dashboard 审核队列已完成；下一节点为审核通过后更新 Obsidian Source Note
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v2.8.md`
3. 本文档
