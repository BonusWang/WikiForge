...
- 当前工程阶段：MVP5 R4-2 MCP 工具清单和权限边界已冻结；当前节点为 R4-3 Source 类 MCP Preview 工具实现
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v3.3.md`
3. 本文档
...
| R4-3 | Doing | 实现 `create_source` / `search_sources` / `get_source` | MCP Preview API | 外部客户端可调用 |
