# 2026-05-23 WikiForge 文档归档索引 v2.9
...
当前已完成 MVP4 AI 辅助整理与审核主闭环，包含 AI 草案生成、审核队列、可配置 AI Provider 和审核通过写入 Obsidian Source Note。下一内部开发节点为 R4 / MVP5 轻量 MCP 预览：
...
- 下一内部开发节点为 R4 / MVP5：轻量 MCP 预览，先冻结 MCP 工具清单和权限边界。
