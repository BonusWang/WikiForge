...
- 当前工程阶段：R4-5 已完成 MCP tools / calls 只读看板、调用日志查询测试和 Agent Team 状态集成；下一步进入 OpenClaw / Hermes 本机接入说明
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v3.9.md`
3. 本文档
...
| R4-5 | In Progress | 展示 MCP 调用日志并编写 OpenClaw / Hermes 接入说明 | UI / MySQL / docs | 每次调用可追踪，本机可按说明接入 |
...
- [ ] R4-5-4 编写 OpenClaw / Hermes 本机接入说明和最小调用样例。
- [ ] R4-5-5 R4-5 集成验证、文档归档、提交推送、合入 main、标签和发布。
