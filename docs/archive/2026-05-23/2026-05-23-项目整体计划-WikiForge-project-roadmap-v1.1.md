...
- 当前工程阶段：MVP4 AI 辅助整理与审核已完成主闭环；Agent 运行账本、审核队列、可配置 AI Provider、Dashboard 审核队列和审核通过写入 Obsidian Source Note 已完成；下一内部开发节点为 MVP5 轻量 MCP 预览
...
| [ ] | S7 MVP5 轻量 MCP | Next | 让 OpenClaw / Hermes / 外部 Agent 能调用 WikiForge | 0.08 | MCP 工具可创建记录、查询 Source、读取 Note |
