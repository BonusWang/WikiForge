# 2026-05-23 WikiForge 文档归档索引 v4.3
...
| `2026-05-23-技术架构-technical-architecture-v1.4.md` | v1.4 | 补充 R4-3 Source 类 MCP Preview 工具实现、调用日志和 R4-4 disabled 工具边界 |
| `2026-05-23-技术架构-technical-architecture-v1.5.md` | v1.5 | 补充 R4-4 Obsidian Note 读取、Personal Record 写入、真实路径校验和下一节点 R4-5 |
...
| `2026-05-23-数据模型-data-model-v1.0.md` | v1.0 | 补充 R4-4 `personal_records` 实际写入范围和 MCP 日志输出脱敏边界 |
...
| `2026-05-23-归档索引-archive-index-v3.4.md` | v3.4 | 补充 R4-3 Source 类 MCP Preview 工具实现、验证结果和下一节点 R4-4 |
| `2026-05-23-归档索引-archive-index-v3.5.md` | v3.5 | 补充 `0.08-preview.1` 阶段预览发布说明 |
| `2026-05-23-归档索引-archive-index-v3.6.md` | v3.6 | 补充 `main` 合并要求、分支管理策略和分支分类治理规则 |
| `2026-05-23-归档索引-archive-index-v3.7.md` | v3.7 | 补充 R4-4 Obsidian Note / Personal Record 工具完成、路径安全审查修复和下一节点 R4-5 |
| `2026-05-23-归档索引-archive-index-v3.8.md` | v3.8 | 补充发布自动化规则、Agent Team 文件夹协作机制和 R4-5 前端侦察结论 |
| `2026-05-23-归档索引-archive-index-v3.9.md` | v3.9 | 补充 R4-5 MCP tools / calls 只读看板、calls 查询测试、自动进入下一轮规则和下一节点 OpenClaw / Hermes 接入说明 |
| `2026-05-23-归档索引-archive-index-v4.0.md` | v4.0 | 补充 R4-5 OpenClaw / Hermes 本机接入说明、Base URL、调用样例和安全边界 |
| `2026-05-23-归档索引-archive-index-v4.1.md` | v4.1 | 补充 R4-5 集成验证、0.08-preview.3 发布候选、MVP5 完成态和发布收口 |
| `2026-05-23-归档索引-archive-index-v4.2.md` | v4.2 | 记录 0.08-preview.3 标签、GitHub Release 和 MVP5 HTTP Preview 主线发布完成 |
| `2026-05-23-归档索引-archive-index-v4.3.md` | v4.3 | 补充 R4-6 MVP 审核加固、默认本机端口绑定、旧分支配置修正和 0.08-preview.4 发布候选 |
...
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v1.6.md` | v1.6 | 标记 R4-3 Source 类 MCP Preview 工具完成，当前指针移动到 R4-4 Obsidian Note 和 Personal Record 工具 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v1.7.md` | v1.7 | 更新最新归档索引入口到 v3.5 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v1.8.md` | v1.8 | 更新当前主线为 `main`，补充分支策略入口和 `0.08-preview.1` 合入主干要求 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v1.9.md` | v1.9 | 标记 R4-4 Done，当前执行指针移动到 R4-5 MCP 调用展示和 OpenClaw / Hermes 接入说明 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v2.0.md` | v2.0 | 补充发布自动化规则、R4-5 Agent Team 工作区和前端只读展示优先结论 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v2.1.md` | v2.1 | 标记 R4-5-1/2/3 完成，当前执行指针移动到 R4-5-4 OpenClaw / Hermes 接入说明 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v2.2.md` | v2.2 | 标记 R4-5-4 完成，当前执行指针移动到 R4-5-5 集成验证和发布收口 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v2.3.md` | v2.3 | 标记 S7 / R4-5 / MVP5 Done，记录 0.08-preview.3 发布候选验证结果 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v2.4.md` | v2.4 | 记录 0.08-preview.3 已发布和 GitHub Release 地址 |
| `2026-05-23-项目整体计划-WikiForge-project-roadmap-v2.5.md` | v2.5 | 补充 R4-6 MVP 审核加固节点和最新归档索引入口 |
...
| `2026-05-23-开发者日志-WikiForge-developer-log-v3.4.md` | v3.4 | 补充 R4-3 Source 类 MCP Preview 工具、TDD 验证和下一节点 R4-4 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v3.5.md` | v3.5 | 补充 `0.08-preview.1` 阶段预览发布范围、边界和 WIP 暂存说明 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v3.6.md` | v3.6 | 补充 `main` 合并原因、分支过多治理方案和后续短生命周期任务分支建议 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v3.7.md` | v3.7 | 补充分支整理、R4-4 实现、并行审查修复和定向测试记录 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v3.8.md` | v3.8 | 补充发布规则变更、Agent Team 独立目录、每 Agent 独立 Prompt / Skill / Workspace / Status 和前端侦察结论 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v3.9.md` | v3.9 | 补充 R4-5 MCP 调用看板只读展示、后端 calls 查询测试、前端构建和浏览器验证记录 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v4.0.md` | v4.0 | 补充 R4-5 OpenClaw / Hermes 本机接入说明、HTTP Preview 接入定位和安全注意事项 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v4.1.md` | v4.1 | 补充 R4-5 集成验证、52 个后端测试、前端构建、Compose config 和发布候选信息 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v4.2.md` | v4.2 | 记录 main 合并、0.08-preview.3 标签和 GitHub prerelease 创建完成 |
| `2026-05-23-开发者日志-WikiForge-developer-log-v4.3.md` | v4.3 | 补充 R4-6 MVP 审核加固、验证结果和 0.08-preview.4 发布策略 |
...
| `2026-05-23-版本更新记录-WikiForge-release-notes-v0.7.md` | v0.7 | 补充 `0.08-preview.1` MVP5 Orchestration + MCP Preview 阶段预览发布说明 |
| `2026-05-23-版本更新记录-WikiForge-release-notes-v0.8.md` | v0.8 | 补充 `0.08-preview.2` R4-4 MCP 预览发布说明、发布自动化规则和 Agent Team 协作目录 |
| `2026-05-23-版本更新记录-WikiForge-release-notes-v0.9.md` | v0.9 | 补充 `0.08-preview.3` R4-5 MCP Dashboard、OpenClaw / Hermes 接入和验证结果 |
| `2026-05-23-版本更新记录-WikiForge-release-notes-v1.0.md` | v1.0 | 补充 `0.08-preview.4` MVP 审核加固发布说明 |
...
| `2026-05-23-MVP5轻量MCP-WikiForge-mvp5-mcp-preview-v0.6.md` | v0.6 | 标记 R4-3 Done，记录 Source 类 MCP Preview 工具实现和验证结果，当前指针移动到 R4-4 |
| `2026-05-23-MVP5轻量MCP-WikiForge-mvp5-mcp-preview-v0.7.md` | v0.7 | 标记 R4-4 Done，记录 Obsidian Note 读取、个人记录写入和路径安全验证，当前指针移动到 R4-5 |
...
| `2026-05-23-MVP5编排辅助工程-WikiForge-orchestration-console-v0.5.md` | v0.5 | 标记 R4-3 完成并移动到 R4-4 Obsidian Note 和 Personal Record 工具 |
...
| `2026-05-23-AI开发规则-AGENTS-v1.4.md` | v1.4 | 补充分支管理规则：阶段成果合入 `main`，远程分支删除需用户确认 |
| `2026-05-23-AI开发规则-AGENTS-v1.5.md` | v1.5 | 补充发布自动化授权和 Agent Team 文件夹式协作规则 |
| `2026-05-23-AI开发规则-AGENTS-v1.6.md` | v1.6 | 补充每轮任务结束后自动进入下一轮，直到 MVP 全流程结束或真实阻塞 |
...
| `2026-05-23-文档目录-docs-index-v0.6.md` | v0.6 | 补充 OpenClaw / Hermes 接入说明入口 |
| `2026-05-23-文档目录-docs-index-v0.7.md` | v0.7 | 补充 MVP 审核报告入口 |
...
| `2026-05-23-工作流-WORKFLOW-v0.3.md` | v0.3 | 更新 Issue 标题示例到当前 R4-4 / R4-5 节点 |
| `2026-05-23-工作流-WORKFLOW-v0.4.md` | v0.4 | 补充分支和隔离规则：主干、阶段分支、任务分支、实验分支和修复分支分开管理 |
| `2026-05-23-工作流-WORKFLOW-v0.5.md` | v0.5 | 补充 Agent Team 文件夹、每 Agent 独立状态文件和 Handoff 规则 |
| `2026-05-23-工作流-WORKFLOW-v0.6.md` | v0.6 | 补充节点完成后自动自检、归档、提交推送并进入下一节点的执行规则 |
| `2026-05-23-分支管理策略-branch-strategy-v0.1.md` | v0.1 | 新增分支分类、合并规则、清理边界和现有 `codex/mvp*` 分支处理建议 |
| `2026-05-23-分支管理策略-branch-strategy-v0.2.md` | v0.2 | 补充发布自动化和 Agent Team 状态文件边界 |
| `agentteam/2026-05-23-R4-5-MCP调用看板-mcp-dashboard-agent-team/` | - | R4-5 Agent Team 工作区，包含主Agent、前端开发Agent、后端开发Agent、测试Agent 的 Prompt、Skill、Workspace 和 Status |
| `agentteam/2026-05-23-R4-5-MCP调用看板-mcp-dashboard-agent-team/agents/主Agent-master-agent/CONTEXT.md` | - | 主Agent 续接上下文，记录当前身份、用户偏好、项目路径、分支、阶段、决策和下一步动作 |
...
| `2026-05-23-MCP接口契约-mcp-api-contract-v0.2.md` | v0.2 | 补充 R4-3 Source 类 MCP Preview 工具实现状态、调用日志和 R4-4 disabled 工具边界 |
| `2026-05-23-MCP接口契约-mcp-api-contract-v0.3.md` | v0.3 | 补充 R4-4 两个工具启用状态、Vault 真实路径校验、个人记录类型错误码和测试覆盖 |
| `2026-05-23-MCP接口契约-mcp-api-contract-v0.4.md` | v0.4 | 补充 R4-5 MCP Preview 只读看板、调用日志分页过滤和 UI 不直接调用工具边界 |
| `2026-05-23-MCP接口契约-mcp-api-contract-v0.5.md` | v0.5 | 补充 OpenClaw / Hermes HTTP Tool / Connector 接入方式和 Base URL 约定 |
| `2026-05-23-MCP接口契约-mcp-api-contract-v0.6.md` | v0.6 | 补充 R4-5 发布候选验证记录和 MVP5 HTTP Preview 完成态 |
| `2026-05-23-MCP接口契约-mcp-api-contract-v0.7.md` | v0.7 | 补充 R4-6 默认本机端口绑定、外部容器接入限制和审核加固记录 |
| `2026-05-23-OpenClaw-Hermes接入说明-WikiForge-openclaw-hermes-mcp-integration-v0.1.md` | v0.1 | 新增 OpenClaw / Hermes 接入 WikiForge MCP HTTP Preview 的本机说明和 PowerShell 示例 |
| `2026-05-23-OpenClaw-Hermes接入说明-WikiForge-openclaw-hermes-mcp-integration-v0.2.md` | v0.2 | 补充默认本机绑定、同一 Compose 网络优先和对外开放安全前提 |
| `2026-05-23-MVP审核报告-WikiForge-mvp-audit-report-v0.1.md` | v0.1 | 新增 MVP 审核报告，整理 R4-6 问题清单、修复内容、剩余风险和验证结果 |
...
| `AI开发Skill-WikiForge-development-skill-v0.9/` | v0.9 | 补充 Agent Team 文件夹、每 Agent 独立 Prompt / Skill / Workspace / Status 和状态 Handoff 规则 |

## 当前阶段结论

当前已完成 `0.08-preview.1` 阶段预览发布准备、`main` 合并、分支治理规则补充、R4-4 Obsidian Note / Personal Record 工具启用，以及 R4-5 Agent Team 文件化协作空间。MVP5 已启用 `search_sources`、`get_source`、`create_source`、`get_obsidian_note`、`create_personal_record` 五个 HTTP Preview 工具；`mcp_tool_calls` 调用日志、`personal_records` 写入、MCP DTO、Service、Controller 和集成测试已落地。

本轮完成 R4-6 MVP 审核加固：发现并修复 Compose 默认将无登录鉴权的 MySQL、Core、Worker、Orchestration、UI 端口暴露到所有网卡的问题，新增 `WIKIFORGE_PORT_BIND=127.0.0.1` 并让生产 / 开发 Compose 默认仅本机可访问；修正 `.env.example` 和 Orchestration Compose 的 `WIKIFORGE_ACTIVE_BRANCH` 默认值为 `main`；补充 OpenClaw / Hermes 外部容器访问前提、同一 Compose 网络优先建议和对外开放安全条件；新增 MVP 审核报告和 `0.08-preview.4` 发布说明。验证通过：后端 Maven 全量测试 5 个模块 52 个测试 0 失败，两个前端构建通过，生产 / 开发 Compose config 通过，渲染端口包含 `host_ip: 127.0.0.1`，Git 空白、敏感信息和禁止路径扫描通过。`0.08-preview.3` 既有标签不移动，本轮以 `0.08-preview.4` 收口审核加固。

本轮完成 R4-5-1/2/3/4/5 并完成发布：Dashboard 新增 MCP Preview 只读看板，展示 MCP tools 清单和 calls 调用日志；前端通过 `frontend/src/api/mcp/` 和 `frontend/src/types/mcp.ts` 接入 API；后端补充 `GET /api/v1/mcp/calls` 查询端点集成测试，并将 MCP calls `pageSize` 上限对齐到 100；新增 OpenClaw / Hermes 接入说明，明确当前采用 HTTP Tool / Custom Action / Connector / Bridge Script 调用 MCP HTTP Preview，并提供本机、Docker 外部容器、Compose 网络内三种 Base URL 和 PowerShell 示例。发布候选验证通过：后端 Maven 全量测试 5 个模块合计 52 个测试，前端构建通过，生产与开发 Compose 配置通过，Git 空白、密钥和禁止路径扫描通过。`main` 已推送到 `e8c5bec`，标签 `0.08-preview.3` 已推送，GitHub prerelease 已创建：https://github.com/BonusWang/WikiForge/releases/tag/0.08-preview.3。MVP5 HTTP Preview 主线完成，后续产品路线进入 V1 在线资料连接器、个人记录持续整理、LifeOS 化记录和向量库准备。
...
- R4-3 Source 类 MCP Preview 工具已完成：`search_sources`、`get_source`、`create_source` 已启用，`get_obsidian_note`、`create_personal_record` 保持 disabled 并进入 R4-4。
- `0.08-preview.1` 阶段预览发布说明已补充到版本更新记录。
- R4-4 Obsidian Note 读取和 Personal Record 写入已完成：`get_obsidian_note`、`create_personal_record` 已启用。
- R4-4 并行审查发现的路径安全阻断点已修复：`vaultPath` 返回前校验相对路径，Markdown 读取前校验最终真实路径仍在 Vault 内。
- R4-4 定向验证通过：`McpPreviewApiIntegrationTests` 共 7 个测试，0 失败。
- 下一内部开发节点为 R4-5：展示 MCP 调用日志，并补充 OpenClaw / Hermes 本机接入说明。
