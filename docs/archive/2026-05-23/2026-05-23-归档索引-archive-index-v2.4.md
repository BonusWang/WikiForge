# 2026-05-23 WikiForge 文档归档索引 v2.4
...
当前已完成 MVP2.1 可用性加固，下一内部开发节点为 MVP3 文档解析：
...
- 当前开发分支为 `codex/mvp2.1-usability-hardening`。
...
- 下一内部开发节点建议进入 R2 / MVP3 文档解析：先冻结正文存储契约，再实现 Markdown / TXT、PDF、Word 基础解析。
