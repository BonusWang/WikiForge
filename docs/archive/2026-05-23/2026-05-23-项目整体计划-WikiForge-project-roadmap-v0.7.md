...
- 当前工程阶段：MVP3 文档解析首轮已实现并验证；Markdown / TXT 正文抽取和 Source Note 摘录已完成；下一内部开发节点为 PDF / Word 基础解析
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v2.5.md`
3. 本文档
...
| [ ] | S5 MVP3 文档解析 | In Progress | 从文件元数据走向正文内容抽取 | 0.06 | Markdown / TXT 已完成；PDF / Word 下一轮 |
