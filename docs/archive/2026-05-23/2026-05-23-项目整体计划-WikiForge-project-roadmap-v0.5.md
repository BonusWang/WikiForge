...
- 当前工程阶段：MVP2 已实现，本地验证通过，R0-5 提交推送完成，版本标签和 GitHub Release 待用户确认
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v2.3.md`
3. 本文档
...
- ( ) S1 MVP0 工程骨架
- ( ) S2 MVP1 源文件归集
- (x) S3 / R0 MVP2 Obsidian Source Note 发布确认
- ( ) S4 / R1 MVP2.1 可用性加固
- ( ) S5 / R2 MVP3 文档解析
...
- ( ) R0-4 发布前自检清单
- ( ) R0-5 提交推送
- (x) R0-6 版本标签和 GitHub Release 确认
...
| R0-6 | Blocked | 版本标签、GitHub Release 和正式发布定义 | tag/release 暂不执行 | 等待用户确认 |
...
6. 等用户确认后再执行 R0-6 版本标签、GitHub Release 和正式发布定义。
