...
- 当前工程阶段：MVP5 R4-3 Source 类 MCP Preview 工具已完成；当前节点为 R4-4 Obsidian Note 读取与个人记录写入
...
1. `AGENTS.md`
2. `docs/archive/2026-05-23/2026-05-23-归档索引-archive-index-v3.4.md`
3. 本文档
...
| R4-4 | Doing | 实现 `get_obsidian_note` / `create_personal_record` | MCP Preview API | Agent 可读 Note、写个人记录 |
...
- `get_obsidian_note`、`create_personal_record` 已进入工具清单但保持 disabled，作为 R4-4 当前节点。
