# 2026-05-23 WikiForge 文档归档索引 v3.1
...
当前已完成 MVP5 R4-1 WikiForge Orchestration 辅助工程骨架，包含独立 `wikiforge-orchestration-service`、独立 `orchestration-ui`、Docker / CI 配置和本地访问入口。下一内部开发节点为 R4-2：冻结 MCP 工具清单和权限边界。
