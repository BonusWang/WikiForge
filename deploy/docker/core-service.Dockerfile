...
COPY --from=build /workspace/backend/wikiforge-core-service/target/wikiforge-core-service-*.jar /app/wikiforge-core-service.jar
EXPOSE 8080
ENTRYPOINT ["java", "-jar", "/app/wikiforge-core-service.jar"]
