...
('资料状态', '待收纳', '待收纳', '文件等待复制到 Raw Sources', 20, 'neutral', 0, 0),
('资料状态', '已收纳', '已收纳', '文件已复制到 Raw Sources', 30, 'success', 0, 1),
('资料状态', '重复文件', '重复文件', '文件内容已存在，已按 hash 去重', 40, 'warning', 1, 0),
('资料状态', '待确认', '待确认', '文件需要人工确认后继续', 50, 'warning', 0, 0),
('资料状态', '收纳失败', '收纳失败', '文件收纳失败', 60, 'danger', 1, 0),
('资料状态', '待抽取', '待抽取', '等待正文抽取', 70, 'neutral', 0, 0),
('资料状态', '抽取中', '抽取中', '正在抽取正文', 80, 'info', 0, 0),
('资料状态', '已抽取', '已抽取', '正文已抽取', 90, 'success', 0, 1),
('资料状态', '部分抽取', '部分抽取', '正文部分抽取成功', 100, 'warning', 0, 0),
('资料状态', '抽取失败', '抽取失败', '正文抽取失败', 110, 'danger', 1, 0),
('资料状态', '待整理到 Wiki', '待整理到 Wiki', '等待整理写入 Obsidian Wiki', 120, 'neutral', 0, 0),
('资料状态', '已写入 Wiki', '已写入 Wiki', '资料已写入 Obsidian Wiki', 130, 'success', 1, 1),
('资料状态', '失败', '失败', '资料处理失败', 140, 'danger', 1, 0),
